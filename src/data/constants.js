...
export const SERVICES = [
  ...
  { num:"02", title:"Art, Heritage & Artifacts",    tags:["Preservation","Govt. Cleared","Climate-Safe"], desc:"Museum-grade handling of paintings, sculptures, and rare artifacts. Trusted by Rashtrapati Bhawan's Art Secretariat for the Presidential Museum." },
  { num:"03", title:"Export & International",       tags:["Vacuum Packing","Moisture Protection","Global"],        desc:"Vacuum packing, export-grade wooden crating. Shipments to USA, UK, Australia, Canada, South Africa, Scandinavia and Dubai." },
  { num:"04", title:"Corporate & IT Assets",        tags:["Same Day Delivery","Chain of Custody","Zero Loss"],    desc:"Large-scale office moves. 100,000+ IT assets relocated for Ameriprise, WNS, Unicharm and WHO South-East Asia." },
...
export const SERVICE_PAGES = {
  "household-relocation": {
    ...
    services: ["Local House Shifting","Intercity Relocation","Apartment & Villa Relocation","Luxury Household Relocation","Packing & Unpacking","Furniture Care","Fragile Goods Handling","Loading & Unloading","Transit Insurance Assistance"],
    process: [
  ...
  "office-relocation": {
    ...
    services: ["Office Furniture Relocation","IT Equipment Relocation","Workstation Dismantling & Installation","Server Room Relocation","Records & File Movement","Corporate Planning & Phased Moves","Weekend & Night Shift Execution","Inventory & Labelling System"],
    process: [
...
export const ALL_PROJECTS = [
  ...
  { client:"WHO South-East Asia",        title:"International Office Move",    tag:"International",  category:"government",  year:"2020–2026", desc:"6 years as the trusted relocation partner for WHO SEARO - a testament to consistent quality and professionalism." },
  ...
  { client:"EPCH · Min. of Textiles",   title:"Shilp Guru Awards",            tag:"Govt. Event",    category:"events",      year:"2025", desc:"National Handicrafts Awards ceremony logistics at Vigyan Bhawan. Display packing, transportation and full event support." },
...
export const FAQ_DATA = {
  General: [
    { q:'How long have you been in business?',         a:'Shree Radhey Relocation Services was established in 2017. We are ISO 9001:2015 certified and have been the trusted relocation partner for WHO South-East Asia for 6 years.' },
...
export const CONTACT_INFO = [
  ...
  { label:"WhatsApp",   value:"+91 8929329666"                     },
